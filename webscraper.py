...
'''
stemming--->removing the suffix and considering the root word
playing-->play
flying-->fly
Sometimes after doing stemming it may result in mispelled words because it is
implementation issue
dancing-->danc
we can use various python modules to correct the mispelled words 
and can retrieve the most relevant word(Additional work)
'''
